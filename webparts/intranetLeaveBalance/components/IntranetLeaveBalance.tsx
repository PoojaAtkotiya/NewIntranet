...
export default class IntranetLeaveBalance extends React.Component<IIntranetLeaveBalanceProps,any> {
   public constructor(props) {
    ...
    this.state = {
      apiUrl:"https://ia-hrms-qa.synovergetech.com/HRMS/GetLeaveBalanceIntranet/",
      employeeCode: "",
      balancePL: "",
      floater: "",
      compOff: "",
      ...
      return (
        <div className={styles.intranetLeaveBalance}>
          <div className={styles.container}>
            <img src={`${logo}`} className={styles.rightalign} />
            <p className={styles.header}>Leave Details</p>
            <div className={styles.balance}><span>BalancePLS : </span>{this.state.balancePL}</div>
            <div className={styles.floater}><span>Floaters : </span>{this.state.floater}</div>
            <div className={styles.compoff}><span>Comp-Off : </span>{this.state.compOff}</div>
            <button
              type="submit"
